...
const Checkbox = (props) => {// constantes checkbox  recibimos props, necesitamos la data 
    const {
        onChange,
    ...
    return (
        <Fragment>
            ...
            <label className="todo new-item">
                <input // este input me permite agregar nuevas tareas, el checkbox me permite ver si la tarea esta terminada y la descripcion del archivo
